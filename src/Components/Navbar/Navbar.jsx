    ...
    return (
        <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-100">
            ...
            <ul className={`lg:flex lg:items-center lg:w-auto lg:space-x-6 ${isOpen ? 'block' : 'hidden'} absolute lg:relative top-full left-0 w-full lg:w-auto bg-gray-100 lg:bg-transparent z-50`}>
                ...
                <li className='md:hidden block'><Link className="block lg:inline-block text-sm text-gray-400 hover:text-gray-500 px-4 py-2 lg:px-0" to="/profile">Profile</Link></li>
            </ul>
